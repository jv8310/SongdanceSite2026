-- Reword the ego line in the part-4 broadcast body: "you are the whole
-- universe" → "you are not a body that happens to be in the universe, but the
-- universe itself, living as you for a while" (clearer than the bare claim).
-- UPDATEs the already-seeded draft (0062/0063) in place, guarded on
