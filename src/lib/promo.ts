...
export const LAUNCH_PROMO_HEADLINE = '50% off all courses';
export const LAUNCH_PROMO_SUBHEAD = `Our new home is here — every course is half price through ${LAUNCH_PROMO_END_LABEL}.`;
